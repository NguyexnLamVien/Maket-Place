...
CREATE TABLE `Images` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `imageAddress` VARCHAR(191) NOT NULL,
    `productId` INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Orders` ADD CONSTRAINT `Orders_promotionCode_fkey` FOREIGN KEY (`promotionCode`) REFERENCES `Promotions`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
